...
Rectangle {
    ...
    Text {
        ...
        z: 20
        opacity: container.uiReady ? 0.72 : 0
    }
                ...
                Item {
                    ...
                    Canvas {
                        ...
                        Image {
                            ...
                            anchors.fill: parent
                            source: Qt.resolvedUrl("assets/avatar-deep-blue.png")
                ...
                Item {
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            color: loginButtonMouse.containsMouse
                                ? Qt.lighter(container.extractedAccent, 1.22)
                                : container.extractedAccent
                        ...
                        scale: loginButtonMouse.pressed ? 0.88 : 1
